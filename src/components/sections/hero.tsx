...
export default function Hero() {
  return (
    <section className="relative bg-[#0a0a0a] pt-[72px]">
      {/* Background glow - single concentrated spotlight like 8lab */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background: "radial-gradient(ellipse 60% 50% at 50% 40%, rgba(255,255,255,0.08) 0%, rgba(255,255,255,0.03) 30%, rgba(255,255,255,0.005) 60%, transparent 80%)",
        }}
      />
        ...
        <div className="relative">
          ...
          <div className="px-8 pb-16 pt-20 text-center sm:px-16 sm:pt-28">
            ...
            <div className="mt-10">
              <Link
                href="#contact"
                className="group inline-flex items-center gap-3 rounded-full bg-white px-7 py-3.5 text-[16px] font-medium text-black transition-all duration-350 hover:scale-[0.975]"
              >
